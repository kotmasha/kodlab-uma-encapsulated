...
protected:
	...
	*/
	...
	//sensors vector reference from Snapshot
	vector<SensorPair*> _sensor_pairs;
	//sensor pairs vector reference from Snapshot
...
public:
	Simulation(vector<Sensor*> &sensors, vector<SensorPair*> &sensor_pairs, std::map<string, Sensor*> &sensor_idx, int initial_sensor_size, string log_dir);
