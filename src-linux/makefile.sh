...
g++ -fPIC -std=c++11 -c UMATest.cpp -o UMATest.o;
swig -c++ -python -o UMA_NEW_wrap.cpp UMA_NEW.i;
gcc -fPIC -c UMA_NEW_wrap.cpp -o UMA_NEW_wrap.o -I/usr/include/python2.7;
nvcc -shared -Xcompiler -fPIC -std=c++11 kernel.cu Agent.o logging.o AgentDM.o UMATest.o UMA_NEW_wrap.o -o _UMA_NEW.so;