...
class Report():
    def __init__(self):
        self.ep_duration=0  #duration of enrichment and pruning procedure
        self.dec_duration=0 #duration of decision cycle
        ...
        for mid in (tmp_id for tmp_id in self._MID if self.dep(tmp_id)):
            ...
            if agentQ:
                if mid in self._AGENTS:  # if mid is an agent...
                    ...
                    agent_reports[mid]['e_and_p_duration']=time.clock()-current_time
                    ...
                    agent_reports[mid]['decision_duration']=time.clock()-agent_reports[mid]['e_and_p_duration']
